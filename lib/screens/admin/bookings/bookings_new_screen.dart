...
class BookingsNewScreen extends StatefulWidget {
  ...
  @override
  State<BookingsNewScreen> createState() => _BookingsNewScreenState();
}
      ...
      child: Container(
        ...
        child: DropdownButton<String>(
          ...
          items: [
            ...
            // all: Agregar lista de conductores
          ],
          onChanged: (newValue) {
              ...
              children: [
                ...
                Container(
                  ...
                  child: Row(
                    ...
                    children: [
                      Icon(Icons.new_releases, size: 18, color: Colors.blue.shade700),

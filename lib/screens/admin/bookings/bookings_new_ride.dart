          ...
          TextFormField(
            ...
            decoration: InputDecoration(
              ...
              hintText: _activeInputType != type
                  ? 'Click "Write" or "Take from map" to select address'
                  : null,
            ),
            validator: validator,
    ...
    return Padding(
      ...
      child: DropdownButtonFormField<String>(
        ...
        items: List.generate(
          driverItems.length,
          (index) =>
              DropdownMenuItem<String>(value: driverItems[index], child: Text(displayItems[index])),
        ),
  ...
  Future<void> _handleCreateRide() async {
    ...
    try {
      ...
      if (_selectedDriver != null && _selectedDriver!.isNotEmpty) {
        rideData['driver_id'] = _selectedDriver;
      }

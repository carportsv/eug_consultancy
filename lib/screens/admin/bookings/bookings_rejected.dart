...
class BookingsRejectedScreen extends StatefulWidget {
  const BookingsRejectedScreen({super.key});

  @override
  State<BookingsRejectedScreen> createState() => _BookingsRejectedScreenState();
}

class _BookingsRejectedScreenState extends State<BookingsRejectedScreen> {
  // ignore: unused_field

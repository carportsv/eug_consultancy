...
class BookingsPaymentPendingScreen extends StatefulWidget {
  ...
  @override
  State<BookingsPaymentPendingScreen> createState() => _BookingsPaymentPendingScreenState();
}
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      if (paymentMethod != 'N/A') ...[
                        ...
                        Row(
                          children: [
                            Icon(Icons.payment, size: 16, color: Colors.orange.shade600),
                            const SizedBox(width: 6),
                            Text(
                              'Método: $paymentMethod',
                              style: GoogleFonts.exo(fontSize: 14, color: Colors.orange.shade600),
                            ),
                          ],
                        ),
                      ],

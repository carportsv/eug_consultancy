...
class BookingsDeletedScreen extends StatefulWidget {
  const BookingsDeletedScreen({super.key});

  @override
  State<BookingsDeletedScreen> createState() => _BookingsDeletedScreenState();
}

class _BookingsDeletedScreenState extends State<BookingsDeletedScreen> {
  // ignore: unused_field

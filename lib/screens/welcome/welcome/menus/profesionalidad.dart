...
class _AcercaDeScreenState extends State<AcercaDeScreen> {
  ...
  void _navigateToTours() {
    ...
    try {
      ...
      if (kDebugMode) {
        debugPrint('[AcercaDeScreen] ❌ Error navegando a ToursScreen: $e');
      }
    }
  }
  ...
  void _navigateToWeddings() {
    ...
    try {
      ...
      if (kDebugMode) {
        debugPrint('[AcercaDeScreen] ❌ Error navegando a WeddingsScreen: $e');
      }
    }
  }
  ...
  void _navigateToTerms() {
    ...
    try {
      ...
      if (kDebugMode) {
        debugPrint('[AcercaDeScreen] ❌ Error navegando a TermsScreen: $e');
      }
    }
  }
  ...
  void _navigateToPrivacy() {
    ...
    try {
      ...
      if (kDebugMode) {
        debugPrint('[AcercaDeScreen] ❌ Error navegando a PrivacyPolicyScreen: $e');
      }
    }
  }
      ...
      appBar: PreferredSize(
        ...
        child: Container(
          ...
          child: WelcomeNavbar(
            ...
            onNavigateToAbout: null, // Ya estamos aquí
        ...
        Expanded(
          ...
          child: Container(
            ...
            child: ClipRRect(
              borderRadius: BorderRadius.circular(_kBorderRadius),
              child: Image.asset(
                'assets/images/empresa/prof_1.png',
                fit: BoxFit.cover,
                height: 500,
